...
## Project Structure
    ...
    ├── testapiautoconnect_122267  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_122267`
...
2. Clone this repo and `cd testapiautoconnect_122267`
